...
def generate_timestamps(transcript, video_duration):
    ...
    # change: batching logic with progress bar
    for i in tqdm(range(1, len(prompts), BATCH_SIZE), desc="🧠 AI Generating", unit="batch"):
...
if __name__ == "__main__":
    # example video url for testing/debugging
    ...
    # example transcript and video duration for testing/debugging
    ...
    video_duration = 361
    if not transcript:
        print("sorry, no transcript, please try another video")
        exit()
    #print(transcript)
    #print(video_duration)
    results = generate_timestamps(transcript, video_duration)
    for r in results:
        print(r)
